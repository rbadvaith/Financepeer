...
<div class="topnav">
 ...
 <div class="topnav">
  <a href="index1.php" target="_parent">Home</a>
  <a class="active" href="index.php" target="_parent">Display Record</a>
</div> 
...
$sql = "SELECT * FROM ttb_data";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["userid"]. "</td><td>" . $row["id"] . "</td><td>" . $row["title"]. "</td><td>" . $row["body"]. "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
